...
<template
	  >
<path fill-rule="evenodd" clip-rule="evenodd" d="M31.3,50.1h3.8c0,0,1.1,0,1.7-0.8c0.5-0.6,0.5-1.7,0.5-1.7s-0.1-5.1,2.3-5.9
	...
	s7.2,16.8,15.3,25.2C22.9,50.7,31.3,50.1,31.3,50.1L31.3,50.1z"/>
</template>
